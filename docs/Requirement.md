...
| **3. Embeddings & Retrieval (FAISS)** | Chunking strategy, embedding generation, FAISS index build/update pipeline | **Reshmitha** |
...
| **6. Documentation, Testing & Presentation** | Problem understanding write-up, PPT, demo script, QA/testing across modules, integration coordination | **Vivek** |
